...
function Avatar() {
    ...
    return (
        ...
        <nav
            class="relative flex w-full flex-wrap items-center justify-between bg-[#B9A7CD] py-2 shadow-dark-mild dark:bg-neutral-700 lg:py-4"
            data-twe-navbar-ref>
                ...
                <div class="relative flex items-center">
                    ...
                    <div class="relative" data-twe-dropdown-ref>
                        ...
                        <ul
                            ...
                            <li>
                                <NavLink
                                    class="block w-full whitespace-nowrap bg-white px-2 py-2 text-sm font-normal text-neutral-700 hover:bg-zinc-200/60 focus:bg-zinc-200/60 focus:outline-none active:bg-zinc-200/60 active:no-underline dark:bg-surface-dark dark:text-white dark:hover:bg-neutral-800/25 dark:focus:bg-neutral-800/25 dark:active:bg-neutral-800/25"
                                    to="Login"
